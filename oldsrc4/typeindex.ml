(* typeindex.ml
   ...
   typeindex system when it's started.  The typeindex checks, and
   gives the result.
   ...
   Well, I still don't like this, but it seems to work.  Now, at worst,
   we can do this AND option #1 above, and make it REALLY efficient.
